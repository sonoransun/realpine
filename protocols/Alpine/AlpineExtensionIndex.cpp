...
bool
AlpineExtensionIndex::getQueryOptionExt(ulong optionId, AlpineQueryOptionData *& optionData)
{
#ifdef _VERBOSE
    Log::Debug("AlpineExtensionIndex::getQueryOptionExt invoked.  Option ID: "s + std::to_string(optionId));
#endif
...
bool
AlpineExtensionIndex::getPeerOptionExt(ulong optionId, AlpinePeerOptionData *& optionData)
{
#ifdef _VERBOSE
    Log::Debug("AlpineExtensionIndex::getPeerOptionExt invoked.  Option ID: "s + std::to_string(optionId));
#endif
...
bool
AlpineExtensionIndex::getProxyOptionExt(ulong optionId, AlpineProxyOptionData *& optionData)
{
#ifdef _VERBOSE
    Log::Debug("AlpineExtensionIndex::getProxyOptionExt invoked.  Option ID: "s + std::to_string(optionId));
#endif
...
{
#ifdef _VERBOSE
    Log::Debug("AlpineExtensionIndex::exists invoked.  Option ID: "s + std::to_string(optionId));
#endif
