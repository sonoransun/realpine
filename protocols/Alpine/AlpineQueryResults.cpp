...
AlpineQueryResults::AlpineQueryResults (ulong                 queryId,
...
bool  
AlpineQueryResults::getResourceList (ulong                                    peerId,
                                     AlpineQueryPacket::t_ResourceDescList &  resourceList)
{
#ifdef _VERBOSE
    Log::Debug ("AlpineQueryResults::getResourceList invoked.  Peer ID: "s +
...
bool  
AlpineQueryResults::processQueryOffer (ulong                peerId,
                                       AlpineQueryPacket *  offer,
                                       AlpineQueryPacket *  request)
{
#ifdef _VERBOSE
    Log::Debug ("AlpineQueryResults::processQueryOffer invoked.  Peer ID: "s +
                std::to_string (peerId));
#endif
    ...
    if (replyHitCount > maxDescPerPeer) {
        ...
        Log::Debug ("Reply hit count exceeds max configured per peer.  Setting to max."s +
                    "\n - Reply Hit Count: "s + std::to_string(replyHitCount) +
...
bool  
AlpineQueryResults::processQueryReply (ulong                peerId,
                                       AlpineQueryPacket *  reply,
                                       AlpineQueryPacket *  request)
{
#ifdef _VERBOSE
    Log::Debug ("AlpineQueryResults::processQueryReply invoked.  Peer ID: "s +
                std::to_string (peerId));
#endif
...
bool  
AlpineQueryResults::verifyQueryOffer (ulong                peerId,
                                      AlpineQueryPacket *  offer)
{
#ifdef _VERBOSE
    Log::Debug ("AlpineQueryResults::verifyQueryOffer invoked.  Peer ID: "s +
                std::to_string (peerId));
#endif
...
bool  
AlpineQueryResults::verifyQueryReply (ulong                peerId,
                                      AlpineQueryPacket *  reply)
{
#ifdef _VERBOSE
    Log::Debug ("AlpineQueryResults::verifyQueryReply invoked.  Peer ID: "s +
                std::to_string (peerId));
#endif
...
bool  
AlpineQueryResults::populateQueryRequest (t_ReplyState *       state,
                                          AlpineQueryPacket *  request)
{
#ifdef _VERBOSE
