...
{
#ifdef _VERBOSE
    Log::Debug("AlpineResourceDesc::setMatchId invoked.  Match ID: "s + std::to_string(matchId));
#endif
...
{
#ifdef _VERBOSE
    Log::Debug("AlpineResourceDesc::setSize invoked.  Size: "s + std::to_string(size));
#endif
...
{
#ifdef _VERBOSE
    Log::Debug("AlpineResourceDesc::setOptionId invoked.  Option ID: "s + std::to_string(optionId));
#endif
