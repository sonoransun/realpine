...
class PacketAuth
{
  public:
    ...
    static bool  setPeerSecret (ulong peerId,
                                const byte * secret,
                                uint secretLen);
    ...
    static bool  computeHmac (ulong peerId,
                              const byte * data,
                              uint dataLen,
                              byte * hmacOut,
                              uint hmacBufSize);

    static bool  verifyHmac (ulong peerId,
                             const byte * data,
                             uint dataLen,
                             const byte * hmac,
                             uint hmacLen);
    ...
    static bool  generateSecret (byte * secretOut,
                                 uint secretBufSize);
