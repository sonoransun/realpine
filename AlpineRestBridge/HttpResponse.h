...
class HttpResponse
{
  public:
    ...
    static HttpResponse  badRequest (const string & message,
                                     const string & errorCode = EC_INVALID_PARAMETER);

    static HttpResponse  methodNotAllowed ();

    static HttpResponse  tooManyRequests (const string & message,
                                          const string & errorCode = EC_RATE_LIMITED);
    ...
    static HttpResponse  serverError (const string & message,
                                      const string & errorCode = EC_INTERNAL_ERROR);
    ...
    static HttpResponse  conflict (const string & message,
                                   const string & errorCode = EC_CONFLICT);
  ...
  private:
    ...
    static string  buildErrorJson (const string & code,
