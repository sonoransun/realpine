...
class UdpConnection
{
  public:
    ...
    virtual bool create(ulong ipAddress = 0, ushort port = 0);
    ...
    virtual bool
    sendData(const ulong destIpAddress, const ushort destPort, const byte * dataBuffer, const uint dataLength);
