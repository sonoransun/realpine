...
class UpnpPortMapper
{
  public:
    ...
    static bool
    addMapping(ushort externalPort, ushort internalPort, const string & protocol, const string & description);
...
class UpnpPortMapper
{
  public:
    ...
    static bool
    addMapping(ushort, ushort, const string &, const string &)
    {
        return false;
    }

    static bool
    removeMapping(ushort, const string &)
    {
        return false;
    }
