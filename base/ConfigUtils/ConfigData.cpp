...
bool
ConfigData::getValue(const string & name, string & value)
{
    auto valueIter = valueIndex_->find(name);
...
bool
ConfigData::getValue(const string & name, t_ValueList & valueList)
{
    auto valueIter = valueListIndex_->find(name);
...
bool
ConfigData::setValue(const string & name, const string & value)
{
    t_ConfigElement * currElement;
...
bool
ConfigData::setValue(const string & name, t_ValueList & valueList)
{
    t_ConfigElement * currElement;
    ...
    if ((currElement->optionType == t_ElementType::String) || (currElement->optionType == t_ElementType::Number)) {
