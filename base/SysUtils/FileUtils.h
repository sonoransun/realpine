...
class FileUtils
{
  public:
    ...
    struct t_FileInfo
    {
        ...
        canRead()
        {
            return (FileUtils::canRead(*this));
        }

        bool
        canWrite()
        {
            return (FileUtils::canWrite(*this));
        }

        bool
        canExecute()
        {
            return (FileUtils::canExecute(*this));
        }
    };
    ...
    static bool getFileInfo(const string & filePath, t_FileInfo & fileInfo);
