...
class PersistenceStore
{
  public:
    ...
    // Peer profiles
    static bool  storePeer (const string & peerId,
    ...
    // Group membership
    static bool  storeGroup (const string & groupId,
    ...
    static bool  storeModule (const string & moduleId,
    ...
    static bool  storeQueryResult (const string & queryString,
                                   const string & resultsJson,
                                   ulong          timestamp);

    static bool  loadQueryResults (const string & queryString,
                                   string &       resultsJson);
    ...
    static bool  executeWithCallback (const string & sql,
