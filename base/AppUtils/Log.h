...
class Log
{
  public:
    ...
    static bool initialize(const std::string & logFileName, t_LogLevel logLevel);
    ...
    static bool stringToLogLevel(std::string_view logLevelStr, t_LogLevel & logLevel);
  ...
  private:
    ...
    static std::string formatStructured(std::string_view logMsg, t_KvPairs kvPairs);
