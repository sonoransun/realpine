...
class AuditLog
{
  public:
    ...
    static void
    record(std::string_view eventType, std::string_view actor, std::string_view action, t_KvPairs details = {});
  ...
  private:
    ...
    static string
    formatEntry(std::string_view eventType, std::string_view actor, std::string_view action, t_KvPairs details);
