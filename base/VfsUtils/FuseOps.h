...
class FuseOps
{
  ...
  private:
    ...
    static int  fuseOpen (const char *             path,
                          struct fuse_file_info *  fi);

    static int  fuseRead (const char *             path,
                          char *                   buf,
                          size_t                   size,
                          off_t                    offset,
                          struct fuse_file_info *  fi);

    static int  fuseRelease (const char *             path,
                             struct fuse_file_info *  fi);
    ...
    //
    static void  populateQueries (VfsNode *       queriesDir,
