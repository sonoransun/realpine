...
class AlpineStackInterface
{
  public:
    ...
    // Query operations
    //
    [[deprecated("use startQuery2")]]
    [[nodiscard]] static bool  startQuery (const t_QueryOptions &  options,
                                           const string &          queryString,
                                           ulong &                 queryId);

    [[nodiscard]] static bool  queryInProgress (ulong  queryId);

    [[deprecated("use getQueryStatus2")]]
    ...
    [[deprecated("use getQueryResults2")]]
    ...
    // Group operations
    //
    [[deprecated("use createGroup2")]]
    [[nodiscard]] static bool  createGroup (const string &  name,
                                            const string &  description,
                                            ulong &         groupId);

    [[nodiscard]] static bool  copyGroup (ulong           copyGroupId,
                                          const string &  name,
                                          const string &  description,
                                          ulong           newGroupId);
    ...
    [[deprecated("use listGroups2")]]
    [[nodiscard]] static bool  listGroups (t_IdList &  groupIdList);

    [[deprecated("use getGroupInfo2")]]
    [[nodiscard]] static bool  getGroupInfo (ulong          groupId,
                                             t_GroupInfo &  groupInfo);

    [[deprecated("use getDefaultGroupInfo2")]]
    [[nodiscard]] static bool  getDefaultGroupInfo (t_GroupInfo &  groupInfo);

    [[deprecated("use getGroupPeerList2")]]
    [[nodiscard]] static bool  getGroupPeerList (ulong       groupId,
                                                 t_IdList &  peerIdList);

    [[deprecated("use getGroupPeerProfile2")]]
    [[nodiscard]] static bool  getGroupPeerProfile (ulong            groupId,
                                                    ulong            peerId,
                                                    t_PeerProfile &  peerProfile);

    [[deprecated("use getDefaultPeerProfile2")]]
    [[nodiscard]] static bool  getDefaultPeerProfile (ulong            peerId,
                                                      t_PeerProfile &  peerProfile);

    [[nodiscard]] static bool  addPeerToGroup (ulong  groupId,
                                               ulong  peerId);

    [[nodiscard]] static bool  removePeerFromGroup (ulong  groupId,
                                                    ulong  peerId);


    // Module operations
    //
    [[deprecated("use registerModule2")]]
    [[nodiscard]] static bool  registerModule (const string &  libraryPath,
    ...
    [[nodiscard]] static bool  setModuleConfiguration (ulong         moduleId,
                                                       ConfigData &  configData);

    [[nodiscard]] static bool  getModuleConfiguration (ulong         moduleId,
                                                       ConfigData &  configData);

    [[deprecated("use getModuleInfo2")]]
    [[nodiscard]] static bool  getModuleInfo (ulong           moduleId,
    ...
    [[deprecated("use listActiveModules2")]]
    [[nodiscard]] static bool  listActiveModules (t_IdList &  idList);

    [[deprecated("use listAllModules2")]]
    [[nodiscard]] static bool  listAllModules (t_IdList &  idList);
    ...
    // Query operations
    //
    [[nodiscard]] static Result<ulong>  startQuery2 (const t_QueryOptions &  options,
                                                     const string &          queryString);
    ...
    // Group operations
    //
    [[nodiscard]] static Result<ulong>  createGroup2 (const string &  name,
                                                      const string &  description);
    ...
    [[nodiscard]] static Result<t_PeerProfile>  getGroupPeerProfile2 (ulong  groupId,
                                                                       ulong  peerId);

    [[nodiscard]] static Result<t_PeerProfile>  getDefaultPeerProfile2 (ulong  peerId);

    [[nodiscard]] static Status  addPeerToGroup2 (ulong  groupId,
                                                   ulong  peerId);

    [[nodiscard]] static Status  removePeerFromGroup2 (ulong  groupId,
                                                        ulong  peerId);


    // Module operations
    //
    [[nodiscard]] static Result<ulong>  registerModule2 (const string &  libraryPath,
