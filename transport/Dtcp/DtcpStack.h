...
class DtcpStack
{
  public:
    ...
    [[nodiscard]] static bool exists(ulong ipAddress, ushort port);
    ...
    [[nodiscard]] static bool locateTransport(ulong transportId, DtcpBaseConnTransport *& transport);

    [[nodiscard]] static bool locateTransport(ulong ipAddress, ushort port, DtcpBaseConnTransport *& transport);

    [[nodiscard]] static bool createTransport(ulong ipAddress, ushort port, DtcpBaseConnTransport *& transport);
    ...
    [[nodiscard]] static bool excludeSubnet(ulong subnetIpAddress, ulong subnetMask);
    ...
    // member types
    //
    using t_IpAddressSet = std::unordered_set<ulong, OptHash<ulong>, equal_to<ulong>>;


    using t_SubnetAddressIndex = std::unordered_map<ulong, t_SubnetAddress *, OptHash<ulong>, equal_to<ulong>>;


    using t_ConnTransportIndex = std::unordered_map<ulong, DtcpBaseConnTransport *, OptHash<ulong>, equal_to<ulong>>;
    ...
    //
    static bool registerAdditionalUdpTransport(DtcpBaseUdpTransport * transport, DtcpBaseConnMux * connMux);
  ...
  private:
    ...
    static bool registerUdpTransport(DtcpBaseUdpTransport * udpTransport, DtcpBaseConnMux * connMux);
