...
bool
DtcpConnectionMap::exists(ulong ipAddress, int port)
{
#ifdef _VERBOSE
...
bool
DtcpConnectionMap::createConnection(ulong ipAddress, int port, ulong & peerId)
{
#ifdef _VERBOSE
...
bool
DtcpConnectionMap::indexConnection(ulong peerId, DtcpBaseConnTransport * connection)
{
#ifdef _VERBOSE
...
bool
DtcpConnectionMap::locateConnection(ulong peerId, DtcpBaseConnTransport *& connection)
{
#ifdef _VERBOSE
...
bool
DtcpConnectionMap::locateConnection(ulong ipAddress, int port, DtcpBaseConnTransport *& connection)
{
#ifdef _VERBOSE
    Log::Debug("DtcpConnectionMap::locateConnection invoked.");
#endif
