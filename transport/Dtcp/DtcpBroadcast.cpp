...
DtcpBroadcast::sendPacket(StackLinkInterface * packet)
{
    ...
    bool status;
    status = DtcpBroadcastMgr::sendPacket(this, packet, destinations_, requestId_);
...
bool
DtcpBroadcast::broadcastComplete(ulong requestId, ulong totalSent)
{
#ifdef _VERBOSE
    ...
    handleSendComplete(totalSent, duration);
